...
/**
 * EventListener to be implemented by objects that want to get callbacks when
 * MP3 tags are received.
 */
public interface TagParseListener extends EventListener {

    /**
     * Called when a tag is found (parsed from the stream, received via UDP,
     * etc.)
     */
