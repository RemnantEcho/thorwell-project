...
public class MpegAudioFileFormat extends TAudioFileFormat {
    ...
    /**
     * MP3 audio file format parameters. Some parameters might be unavailable.
     ...
     * <li><b>mp3.version.encoding</b> [String], mpeg encoding : MPEG1,
     * MPEG2-LSF, MPEG2.5-LSF
     * <li><b>mp3.channels</b> [Integer], number of channels 1 : mono, 2 :
     * stereo.
     ...
     * <li><b>mp3.framesize.bytes</b> [Integer], framesize of the first frame.
     * framesize is not constant for VBR streams.
     * <li><b>mp3.framerate.fps</b> [Float], framerate in frames per seconds.
     * <li><b>mp3.header.pos</b> [Integer], position of first audio header (or
     * ID3v2 size).
     ...
     * <li><b>mp3.mode</b> [Integer], mode 0:STEREO 1:JOINT_STEREO
     * 2:DUAL_CHANNEL 3:SINGLE_CHANNEL
     ...
     * <li><b>mp3.id3tag.v2.version</b> [String], ID3v2 major version (2=v2.2.0,
     * 3=v2.3.0, 4=v2.4.0).
