...
public class MpegAudioFormat extends TAudioFormat {
    ...
    /**
     * MP3 audio format parameters. Some parameters might be unavailable. So
     * availability test is required before reading any parameter.
     *
     * <br>AudioFormat parameters.
     * <ul>
     * <li><b>bitrate</b> [Integer], bitrate in bits per seconds, average
     * bitrate for VBR enabled stream.
