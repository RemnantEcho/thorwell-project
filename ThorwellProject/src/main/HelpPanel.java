...
public class HelpPanel extends JPanel {
    ...
    Dimension panelDimensions = new Dimension(640, 360);
     ...
     * current class.
     */
    public HelpPanel(GameWorld world, int width, int height, KeyController keyController) {
        this.world = world;
        ...
        try {
            bimage = ImageIO.read(new File("./data/helpmenu.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        closeButton = new CloseButton(560, 0, this);
