...
public class CloseButton extends JButton {
     ...
     */
    public CloseButton(int x, int y, HelpPanel help) {
        this.help = help;
        ...
        this.setIcon(new ImageIcon("./data/buttons/closebutton.gif"));
        this.setRolloverIcon(new ImageIcon("./data/buttons/closebuttonhover.gif"));
